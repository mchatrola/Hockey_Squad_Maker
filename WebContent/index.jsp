...
<body onload="loadJsonFile()">    
    ...
    <display:table name="requestScope.playerWaitList" requestURI="#tab1" pagesize="10" sort="page" uid="one">    
    ...
    <c:forEach var = "squad" items="${requestScope.squadList}" varStatus="status">
        <h2 style="color:green;">Squad <c:out value="${status.count}" /> (<c:out value="${squad.size()}"/> Players)</h2>        
